...
DEFAULT_PIPECONF = "org.p4.template"
STRATUM_BMV2 = 'stratum_bmv2'
STRATUM_INIT_PIPELINE = '/home/p4/ORACLE_ddos/p4src/build/bmv2.json'
...
class StratumBmv2Switch(Switch):
    ...
    def __init__(self, name, json=STRATUM_INIT_PIPELINE, loglevel="trace",
